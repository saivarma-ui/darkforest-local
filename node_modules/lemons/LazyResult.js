...
var LazyResult = /*#__PURE__*/function () {
  ...
  _createClass(LazyResult, [{
    ...
    key: "mapSuccess",
    value: function mapSuccess(mapFn) {
      return this.dispatch(function () {
        ...
        return LazyResult.success(mapFn(value));
      });
    }
  }, {
    key: "mapFailure",
    value: function mapFailure(mapFn) {
      return this.dispatch(function () {
        return LazyResult.initial();
      }, function () {
        return LazyResult.loading();
      }, function (error) {
        return LazyResult.failure(mapFn(error));
      }, function (value) {
        return LazyResult.success(value);
      });
    }
  }, {
    key: "value",
